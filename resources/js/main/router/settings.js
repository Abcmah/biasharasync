...
import PaymentProviders from '../views/settings/payment-providers/index.vue'
...
export default [
    {
        ...
        children: [
            ...
            },
            {
                ...
                name: 'admin.settings.payment_providers.index',
                meta: {
                    requireAuth: true,
                    menuParent: "settings",
                    menuKey: route => "payment_providers",
                    permission: "payment_providers_view"
                }
            },
            {
                path: 'units',
