<template>
                ...
                <div class="pos1-left-wrapper">
                    ...
                    <div class="pos-left-footer">
                        ...
                        <div :style="{
                            ...
                            <a-row :gutter="16" style="margin-bottom: 10px;" justify="end">
                                <a-col>
                                    <a-space>
                                        <a-button type="default" style="background:#faad14;color:#fff;border:none"
                                            @click="suspendSale">
                                            Suspend
                                        </a-button>

                                        <a-button type="default" style="background:#389e0d;color:#fff;border:none"
                                            @click="openSuspendedSales">
                                            Restore
                                        </a-button>
                                    </a-space>
                                </a-col>
    ...
    <a-modal v-model:open="showSuspendModal" title="Suspended Sales (F8)" width="700px" :footer="null">
        <a-table :columns="suspendColumns" :dataSource="suspendedSales" rowKey="id">
            <template #bodyCell="{ column, record }">
                <template v-if="column.dataIndex == 'action'">
                    <a-space>
                        <a-button type="primary" @click="restoreSale(record)">
                            Restore
                        </a-button>

                        <a-button danger @click="deleteSuspendedSale(record.id)">
                            Delete
                        </a-button>
                    </a-space>
                </template>
...
export default {
    ...
    setup() {
        ...
        const restoreSale = (record) => {
            ...
            suspendedSales.value = suspendedSales.value.filter(
                (sale) => sale.id !== record.id
            );
        ...
        const deleteSuspendedSale = (id) => {
            suspendedSales.value = suspendedSales.value.filter((sale) => sale.id !== id);
            localStorage.setItem("suspendedSales", JSON.stringify(suspendedSales.value));
...
// Custom Button Colors to replace inline styles
.btn-suspend {
    background: #fffbe6;
    border-color: #ffe58f;
    color: #d48806;
