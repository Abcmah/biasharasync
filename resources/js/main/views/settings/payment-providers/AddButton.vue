<template>
	<div v-if="permsArray.includes('payment_providers_view') || permsArray.includes('admin')">
		...
		<AddEdit
			...
			:formData="formData"
			:data="formData"
			:pageTitle="$t('payment_provider.add')"
			:successMessage="$t('payment_provider.created')"
		/>
	</div>
</template>
