...
ApiRoute::group(['namespace' => 'App\Http\Controllers\Api'], function () {
    ...
    ApiRoute::group(['middleware' => ['api.permission.check', 'api.auth.check', 'license-expire']], function () {
        ...
        ApiRoute::post('pos/payment/stkpush', ['as' => 'api.pos.payment-stkpush', 'uses' => 'PosController@addPosMpesaStkpushPayment']);
        ...
        // ApiRoute::get('pos/payment/mpesa/check-status', ['as' => 'api', 'uses' => 'PosController@checkMpesaStkPushPayment']);
         Route::get('api/v1/pos/payment/mpesa/check-status', [\App\Http\Controllers\Api\PosController::class, 'checkMpesaStkPushPayment']);
        ...
        ApiRoute::resource('payment-providers', 'PaymentProviderController', ['as' => 'api', 'except' => ['index']]);
