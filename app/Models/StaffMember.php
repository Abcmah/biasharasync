...
class StaffMember extends BaseModel implements AuthenticatableContract, JWTSubject, LaratrustUser
{
    ...
    {
        return $this->belongsTo(\Modules\StockiflyHrm\Entities\Shift::class);
    }
}
